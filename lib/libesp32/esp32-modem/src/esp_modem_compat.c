...
{
#if CONFIG_LWIP_PPP_PAP_SUPPORT && defined(GSMPPP_MODEM_PPP_AUTH_USERNAME) && defined(GSMPPP_MODEM_PPP_AUTH_PASSWORD)
    esp_netif_auth_type_t auth_type = NETIF_PPP_AUTHTYPE_PAP;
#elif CONFIG_LWIP_PPP_CHAP_SUPPORT && defined(GSMPPP_MODEM_PPP_AUTH_USERNAME) && defined(GSMPPP_MODEM_PPP_AUTH_PASSWORD)
    esp_netif_auth_type_t auth_type = NETIF_PPP_AUTHTYPE_CHAP;
#elif defined(GSMPPP_MODEM_PPP_AUTH_USERNAME) && defined(GSMPPP_MODEM_PPP_AUTH_PASSWORD)
...
#if defined(GSMPPP_MODEM_PPP_AUTH_USERNAME) && defined(GSMPPP_MODEM_PPP_AUTH_PASSWORD)
    esp_netif_ppp_set_auth(esp_netif, auth_type, GSMPPP_MODEM_PPP_AUTH_USERNAME, GSMPPP_MODEM_PPP_AUTH_PASSWORD);
#endif
